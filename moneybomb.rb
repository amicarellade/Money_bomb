...
class Tutorial < Gosu::Window
    def initialize
        ...
        @cash = Gosu::Image.load_tiles("media/money.png", 25, 25)
        @cashs = Array.new
        @font = Gosu::Font.new(20)

        @coin = Gosu::Image.load_tiles("media/coin.png", 25, 25)
        @coins = Array.new
        @font = Gosu::Font.new(20)

        @bomb = Gosu::Image.load_tiles("media/bomb.png", 25, 25)
        @bombs = Array.new
        @font = Gosu::Font.new(20)
...
class Player
    ...
    def initialize
        @image = Gosu::Image.new("media/mario_PNG49.png") 
        @x = 0
        @y = 0
        # @lives = 3 
        @score = 0
    ...
    # def hit_by?(bomb)
    #     @exploded = bomb.any? {|bullet| Gosu::distance(bomb.x, bomb.y, @x, @y) < 20}
    #     if @exploded
    #         @lives = @lives - 1
    #     end
    #     @exploded
